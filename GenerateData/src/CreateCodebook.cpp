...
int main()
{
	char inputFile[50],dcFile[50], riFile[50], lpcFile[50], cepsFile[50],startEndLogFile[50],allCepsFile[50];
	char tempInputFile[50],tempDcFile[50], tempRiFile[50], tempLpcFile[50], tempCepsFile[50],tempStartEndLogFile[50];
	int frameSize, noOfP;
	double piValue;


	char vqcFile[50],tvFile[50],distOpFile[50],logFile[50];
